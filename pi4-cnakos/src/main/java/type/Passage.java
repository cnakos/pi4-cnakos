...
public class Passage extends ComponentAnnotation {
  ...
  */  
  ...
  /** getter for originalText - gets The original text for the passage, before any cleaning occurred.
   * @generated
   * @return value of the feature 
   */
  ...
  /** setter for originalText - sets The original text for the passage, before any cleaning occurred. 
   * @generated
   * @param v value to set into the feature 
   */
  ...
  /** getter for tokens - gets The tokens in the Passage's text.
   * @generated
   * @return value of the feature 
   */
  public FSList getTokens() {
    if (Passage_Type.featOkTst && ((Passage_Type)jcasType).casFeat_tokens == null)
      jcasType.jcas.throwFeatMissing("tokens", "type.Passage");
    return (FSList)(jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas.ll_getRefValue(addr, ((Passage_Type)jcasType).casFeatCode_tokens)));}
    
  /** setter for tokens - sets The tokens in the Passage's text. 
   * @generated
   * @param v value to set into the feature 
   */
  public void setTokens(FSList v) {
    if (Passage_Type.featOkTst && ((Passage_Type)jcasType).casFeat_tokens == null)
      jcasType.jcas.throwFeatMissing("tokens", "type.Passage");
    jcasType.ll_cas.ll_setRefValue(addr, ((Passage_Type)jcasType).casFeatCode_tokens, jcasType.ll_cas.ll_getFSRef(v));}    
   
    
  //*--------------*
  //* Feature: ngrams

  /** getter for ngrams - gets The n-grams in the Passage's text.
   * @generated
   * @return value of the feature 
   */
  public FSList getNgrams() {
    if (Passage_Type.featOkTst && ((Passage_Type)jcasType).casFeat_ngrams == null)
      jcasType.jcas.throwFeatMissing("ngrams", "type.Passage");
    return (FSList)(jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas.ll_getRefValue(addr, ((Passage_Type)jcasType).casFeatCode_ngrams)));}
    
  /** setter for ngrams - sets The n-grams in the Passage's text. 
   * @generated
   * @param v value to set into the feature 
   */
  public void setNgrams(FSList v) {
    if (Passage_Type.featOkTst && ((Passage_Type)jcasType).casFeat_ngrams == null)
      jcasType.jcas.throwFeatMissing("ngrams", "type.Passage");
    jcasType.ll_cas.ll_setRefValue(addr, ((Passage_Type)jcasType).casFeatCode_ngrams, jcasType.ll_cas.ll_getFSRef(v));}    
  }
